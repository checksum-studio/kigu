...
kigu is free and closed source. This repository holds only its releases and issue tracker. Using kigu means
accepting its [license agreement](EULA.txt), which kigu shows when it first starts and which is also included with
the download. Tips on [Ko-fi](https://ko-fi.com/checksum) are welcome; they are gifts and
unlock nothing.
